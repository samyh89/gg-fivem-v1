...
Config.CartelStations = {
  ...
  Cartel = {
   ...
   --   { name = 'WEAPON_HEAVYSNIPER',      price = 2000000 },
    ...
    Cloakrooms = {
      { x = -890.4, y = 179.24, z = 68.75},
    },

    Armories = {
      { x = -888.99, y = 187.76, z = 69.03},
    },

    Vehicles = {
      {
        Spawner    = { x = -912.89, y = 198.51, z = 68.8 },
        SpawnPoint = { x = -909.46, y = 181.64, z = 68.75 },
        Heading    = 94.39,
      }
    },
    ...
    Helicopters = {
      {
        Spawner    = { x = -922.42, y = 165.76, z = 65.15 },
        SpawnPoint = { x = -928.85, y = 174.44, z = 65.69 },
        Heading    = 95.16,
      }
    },

    VehicleDeleters = {
      { x = -906.86, y = 198.76, z = 68.8 },
