...
Citizen.CreateThread(function()
  while true do
   ...
   if IsControlPressed(0,  Keys['=']) and PlayerData.job ~= nil and PlayerData.job.name == 'fbi' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'fbi_actions') and (GetGameTimer() - GUI.Time) > 150 then
     OpenFBIActionsMenu()
     GUI.Time = GetGameTimer()
    end
...
RegisterNetEvent('NB:openMenuFBI')
AddEventHandler('NB:openMenuFBI', function()
	OpenFBIActionsMenu()
end)
